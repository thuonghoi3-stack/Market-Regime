...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BXTl_meJ.mjs");
...
var manifest = { "52b584fb1f45afb59b233aa0a8411366524da992d053cd083f54732a5f68bdfc": {
	functionName: "getMarketSnapshot_createServerFn_handler",
	importer: () => import("./api-BF9z_JDW.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Byv-IEeB.mjs").then((n) => n.t),
